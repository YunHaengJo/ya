      ...
      <div class="row">
        ...
        <tr>
         ...
         <input type="hidden" id="command" name="command" value="">
        	...
        	<button class="input-group-addon" id="write" style="width: 356px; height: 30px; background-color: white;" onclick="mySubmit(1)">전체 문의 내역</button>
            <button class="input-group-addon" style="width: 356px; height: 30px; background-color: #ededed;" onclick="mySubmit(2)">답변 미처리 내역</button>
        	</div>
        	</td>
        	<td></td>
        	</form>
